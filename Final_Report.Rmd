...
- Graph displaying how different age groups (children, adults, elderly) may be affected differently by air quality in health outcomes
  - This last plot was merged into shiny bargraph as an age group filter.
...
The website that we built for this project can be found [here](https://darwinthebeagle.github.io/asthma_nyc/)

### Acknowledgements:

Many thanks to Professor Jeff Goldsmith, his awesome [site](http://p8105.com/index.html) and the teaching team. Special thanks to our teaching assistant for this project Junting Ren for answering all our many questions.
